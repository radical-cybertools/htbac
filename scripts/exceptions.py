...
class htbacError(Exception):
    """htbacError is the base exception raised by Ensemble Toolkit"""

    def __init__(self, msg):
        super(htbacError, self).__init__(msg)


class TypeError(htbacError):
