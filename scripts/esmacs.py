...
class esmacs(object):
    ...
    def __init__(self, resource, replicas, rootdir, cores, kernel):
        self.name = esmacs
            ...
            for replica_ind in range(num_tasks):
                ...
                t3.copy_input_data = [
                    '{stage2}/{input1}/replicas/rep{input2}/equilibration/holder > {input1}/replicas/rep{input2}/equilibration/holder'.format(
                        stage2=stage_2_ref[replica_ind], input1=rootdir, input2=replica_ind)]
            ...
            for replica_ind in range(num_tasks):
                ...
                t4.copy_input_data = [
                    '{stage3}/{input1}/replicas/rep{input2}/equilibration/eq0.coor > {input1}/replicas/rep{input2}/equilibration/eq0.coor'.format(
                        stage3=stage_3_ref[replica_ind], input1=rootdir, input2=replica_ind),
            ...
            for replica_ind in range(num_tasks):
                ...
                t5.copy_input_data = [
                    '{stage4}/{input1}/replicas/rep{input2}/equilibration/eq0.coor > {input1}/replicas/rep{input2}/equilibration/eq0.coor'.format(
                        stage4=stage_4_ref[replica_ind], input1=rootdir, input2=replica_ind),
            ...
            for replica_ind in range(num_tasks):
                ...
                t6.copy_input_data = [
                    ...
                    '{stage5}/{input1}/replicas/rep{input2}/equilibration/eq0.coor > {input1}/replicas/rep{input2}/equilibration/eq0.coor'.format(
                        stage5=stage_5_ref[replica_ind], input1=rootdir, input2=replica_ind),
